...
class MainDialog(ComponentDialog):
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            msg_txt = f"I have you booked to {result.destination} from {result.origin} on {result.start_date} with a return flight on {result.end_date} and a budget of {result.budget}"
